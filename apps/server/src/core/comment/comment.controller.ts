...
export class CommentController {
  ...
  // MXD: fork-owned resolve/re-open. Upstream ships resolution only in its
  // EE build, which this deployment doesn't run; this is the AGPL-core
  // equivalent, gated like any other comment action.
  @HttpCode(HttpStatus.OK)
  @Post('resolve')
  async resolve(
